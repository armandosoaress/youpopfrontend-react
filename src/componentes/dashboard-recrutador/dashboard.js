...
function Dashboardrecrutadorlayout() {

    const [data, setData] = useState([]);
    const [userlog, setUserlog] = useState([]);
    const [recrutedusers, setrecruteusers] = useState([]);
    ...
    const recruteusers = async (responseJson) => {
        setrecruteusers(responseJson.Recrutadores);
    }
                ...
                <div className="flex-grow overflow-hidden h-full flex flex-col">
                    ...
                    <div className="flex-grow flex overflow-x-hidden">
                        <div className="xl:w-72 w-48 flex-shrink-0 border-r border-gray-200 dark:border-gray-800 h-full overflow-y-auto lg:block hidden p-5">
                            ...
                            {
                                            Object.values(recrutedusers).map(Recrutadores => (

                                                <>
                                                     <button onClick={() => redirect(Recrutadores.id)} className="bg-white p-3 w-full flex flex-col rounded-md dark:bg-gray-800 shadow">
                                                ...
                                                <div className="flex items-center w-full">
                                                    <div className="text-xs py-1 px-2 leading-none dark:bg-gray-900 bg-yellow-100 text-yellow-600 rounded-md">  {Recrutadores.funcao}</div>
                                                </div>
                                            </button>
                            ...
                            <div className="sm:p-7 p-4">
                                <table className="w-full text-left">
                                    ...
                                    <tbody className="text-gray-600 dark:text-gray-100">
                                        ...
                                        {
                                            Object.values(data).map(supervisores => (

                                                <>
                                                    <tr className='usersdados' onClick={() => redirectdependent(supervisores.id)}>
                                                        ...
                                                        <td className="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 md:table-cell hidden"> {supervisores.telefone}</td>
                                                        <td className="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 text-red-500"> {supervisores.endereco}</td>
                                                        <td className="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800">
                                                            <div className="flex items-center">
...
export default Dashboardrecrutadorlayout;
